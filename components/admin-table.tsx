// /**
//  * File: components/admin-table.tsx
//  * Purpose: Reusable table component with pagination, search, and filters
//  * Features: Server-side pagination, search, bulk actions, row actions
//  */
